export default { 
    id: 1, 
    featured: true, // Đánh dấu bài viết này là nổi bật true và false (Hiển thị to nhất trang chủ)
    category: "PHONG_THUY",
    title: "5 Loại cây phong thủy hút tài lộc năm 2025", 
    excerpt: "Bài trí cây cảnh đúng cách giúp thanh lọc không khí và mang lại may mắn.", 
    ...
    <p>Tính từ thời điểm hiện tại (Tháng 2/2025), chúng ta còn khoảng <strong>hơn 360 ngày</strong> nữa là đến thời khắc Giao thừa thiêng liêng của năm Bính Ngọ.</p>
    
    <!-- KHUNG ĐẾM NGƯỢC (Được Javascript kích hoạt) -->
    <div class="tet-banner animate-fade-in" style="margin: 2rem 0;" id="tet-countdown-box">
       <!-- Hoa văn trang trí -->
       <div class="flower flower-mai pos-1 animate-sway">🌼</div>
       <div class="flower flower-dao pos-2 animate-sway">🌸</div>
       <div class="flower flower-mai pos-3 animate-sway">🌼</div>
       <div class="flower flower-dao pos-4 animate-sway">🌸</div>

       <div class="text-center tet-banner-content">
    ...
    <div class="video-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/S432wS7lYwE" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
    <p class="text-center italic text-sm text-gray-500 mt-2 mb-6">Giai điệu mùa xuân mang lại may mắn và tài lộc (Video minh họa)</p>
