...
export default { 
    id: 11, 
    featured: true, // Đánh dấu bài viết này là nổi bật (Hiển thị to nhất trang chủ)
    category: "LE_TET",
    ...
    image: "https://images.unsplash.com/photo-1548695602-992520863923?q=80&w=1280&h=720&auto=format&fit=crop", 
    date: "02/01/2025", 
    author: "Ban Biên Tập",
    content: `
    ...
    <div class="video-container">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/dLDAXm2kc3E" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
